...
var Typer = {
    ...
    addText: function (key) {//Main function to add the code
        ...
        if (key.key === 'Alt') {// key 18 = alt key
            ...
            window.scrollBy(0, 70); // scroll to make sure bottom is always visible
        }
        if (key.preventDefault && !isFunctionalKey(key.key)) { // block all keys but Functional
            key.preventDefault()
        }
    },
